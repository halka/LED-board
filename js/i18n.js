const LOCALES = {
  ja: {
    ...
    statusImageLayerAdded: '画像を追加しました',
    statusImageChanged:    '画像を変更しました',
    statusFillLayerAdded:  'ベタ塗りを追加しました',
    statusGlobalUpdated:   '全体設定を更新しました',
    statusDragging:        '文字をドラッグ中',
    statusResizing:        'レイヤーをリサイズ中',
    ...
    statusLayerShown:    'レイヤーを表示しました',
    statusLayerHidden:   'レイヤーを非表示にしました',
    statusLayerReordered:'レイヤーの順序を変更しました',
    // ── Save / record ──────────────────────────────────────────
    generating:       '{0} を生成中...',
    ...
    // ── Layer card ─────────────────────────────────────────────
    layerTitle:       '文字 {0}',
    imageLayerTitle:  '画像 {0}',
    fillLayerTitle:   'ベタ塗り {0}',
    textLayerDefaultName: '文字レイヤー',
    imageLayerDefaultName:'画像レイヤー',
    fillLayerDefaultName: 'ベタ塗り',
    toggleVisibility:     '表示/非表示',
    noLayerSelectedHint:  'レイヤーを選択してください（ドラッグで並べ替え、目玉で表示切替）',
    imageFile:        '画像ファイル',
    chooseImage:      '画像を選択',
    noImageSelected:  '画像未選択',
    imageWidth:       '幅(px)',
    imageHeight:      '高さ(px, 0=自動)',
    fillHeight:       '高さ(px)',
    fillColor:        '塗りつぶし色',
    cornerRadius:     '角丸(px)',
    tintColor:        '単色化',
    alphaThreshold:   '透過しきい値(0-255)',
    layerOrder:       '表示順 {0}/{1}',
    toBack:           '最背面',
    backward:         '後ろへ',
    forward:          '前へ',
  ...
  en: {
    ...
    statusImageLayerAdded: 'Image added',
    statusImageChanged:    'Image updated',
    statusFillLayerAdded:  'Fill added',
    statusGlobalUpdated:   'Settings updated',
    statusDragging:        'Dragging text',
    statusResizing:        'Resizing layer',
    ...
    statusLayerReordered:'Layers reordered',
    // ── Save / record ──────────────────────────────────────────
    ...
    // ── Layer card ─────────────────────────────────────────────
    layerTitle:       'Text {0}',
    imageLayerTitle:  'Image {0}',
    fillLayerTitle:   'Fill {0}',
    textLayerDefaultName: 'Text layer',
    imageLayerDefaultName:'Image layer',
    fillLayerDefaultName: 'Fill',
    toggleVisibility:     'Toggle visibility',
    noLayerSelectedHint:  'Select a layer (drag rows to reorder, eye icon to hide)',
    imageFile:        'Image file',
    chooseImage:      'Choose image',
    noImageSelected:  'No image selected',
    imageWidth:       'Width (px)',
    imageHeight:      'Height (px, 0 = auto)',
    fillHeight:       'Height (px)',
    fillColor:        'Fill color',
    cornerRadius:     'Corner radius (px)',
    tintColor:        'Tint',
    alphaThreshold:   'Alpha threshold (0-255)',
